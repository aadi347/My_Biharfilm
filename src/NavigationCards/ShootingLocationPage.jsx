  ...
  "Garden & Parks ": [
    ...
    },
    {
      ...
      img: "https://film.bihar.gov.in/assets/Gardens%20and%20Parks/Venuvan%20Nalanda%20000.jpg",
       description: "A historic pond in Patna associated with local legends, often used for rituals.",
    lat: 25.6290,
    lng: 85.1195  
    },
    {
...
return (
  ...
  >
    ...
    <div className="bg-[#190108] w-full pt-10 px-2 sm:px-6 lg:px-10">
      {/* Title */}
      <h2 className="text-white text-4xl sm:text-5xl font-bold text-center mb-12">
        Explore Locations
      </h2>
